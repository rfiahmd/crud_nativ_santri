...
$operator = mysqli_query($kon, "SELECT * FROM data_operator");
$jurusan = mysqli_query($kon, "SELECT * FROM data_jurusan");
$laki = mysqli_query($kon, "SELECT * FROM data_santri where jns_klmn ='Laki-Laki'");
$perempuan = mysqli_query($kon, "SELECT * FROM data_santri where jns_klmn ='Perempuan'");
							...
							<div class="card-body">
								<div class="media align-items-center">
									...
									<div class="media-body">
										...
										<span class="title text-black font-w600"><?= mysqli_num_rows($jurusan) ?></span>
									</div>
								</div>
							...
							<div class="card-body">
								<div class="media align-items-center">
									...
									<div class="media-body">
										...
										<span class="title text-black font-w600"><?= mysqli_num_rows($operator) ?></span>
									</div>
								</div>
								<div class="progress" style="height:5px;">
								...
								<div class="media align-items-center">
									...
									<div class="media-body">
										...
										<span class="title text-black font-w600">
											<?= mysqli_num_rows($laki) ?> / <?= mysqli_num_rows($perempuan) ?>
										</span>
									</div>
								</div>
								<div class="progress" style="height:5px;">
							...
							<div class="card-body">
								<div class="media align-items-center">
									...
									<div class="media-body">
										...
										<span class="title text-black font-w600"><?= mysqli_num_rows($laki) + mysqli_num_rows($perempuan) ?></span>
									</div>
								</div>
								<div class="progress" style="height:5px;">
					...
					<div class="col-12">
						<div class="table-responsive">
							<table class="table table-bordered">
								...
								<tbody>
									<?php foreach ($jurusan as $get) : ?>
										<tr>
											<td><?= $get['nama_jurusan'] ?></td>
											<td>
												<?php $jum_santri = mysqli_query($kon, "SELECT id_sntri from data_santri where id_jurusan = '$get[id_jurusan]'") ?>
												<?= mysqli_num_rows($jum_santri) ?>
											</td>
										</tr>
									<?php endforeach; ?>
								</tbody>
					...
					<div class="col-lg-12">
						<div class="card bg-gra" style=" box-shadow: 0 1px 8px rgb(153 153 153 / 20%), 0 3px 4px rgb(255 255 255 / 14%), 0 3px 3px -2px rgb(255 255 255 / 12%);">
							<div class="card-body">
								<div class="row d-flex">
									<div class="col-md-8">
										<h4 class="text-bold text-weight-bolder" style="color: #000; text-shadow: #fff 1px 2px 2px; margin-bottom:2px;">
											...
											Informatika<span style="font-size: 12px;"> Uniba Madura</span>
										</h4>
								...
								<div class="mt-4">
									<h5 class="mb-0" style="color: #008eff">Selamat Datang, <?php echo $_SESSION['nama_operator']; ?></h5>
								</div>
							</div>
						</div>
					</div>
...
<div class="container text-center mt-3 col-lg-9 margin-left">
