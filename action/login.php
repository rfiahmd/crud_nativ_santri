                                ...
                                <div class="auth-form">
                                    ...
                                    if (isset($_GET['err'])) {
                                        ...
                                        if ($error == 'true') {
                                            ...
                                            <div class="alert alert-warning alert-dismissible alert-alt fade show">
                                                ...
                                                <strong>Peringatan!</strong> Tidak bisa masuk, diharap melakukan login terlebih dahulu.
                                            </div>
                                            ';
                                        } else {
                                            echo '
                                    ...
                                    if (isset($_POST['login'])) {
                                        ...
                                        if (mysqli_num_rows($cek) > 0) {
                                            ...
                                            mysqli_query($kon, "UPDATE data_operator SET last_logout = '$waktu_login' WHERE id_operator = '$get[id_operator]'");
