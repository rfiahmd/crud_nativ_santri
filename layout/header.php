...
if (!isset($_SESSION['id_operator'])) {
    header("Location: ../action/login.php?err=true");
}
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-bs-toggle="dropdown">
                                    <img src="../assets/images/rofie.jpg" width="20" alt="">
                                    <div class="header-info">
                                        <span class="text-black"><strong><?php echo $_SESSION['nama_operator']; ?></strong></span>
                                        <p class="fs-12 mb-0"><?php echo $_SESSION['email_operator']; ?></p>
                                    </div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="../action/logout.php" class="dropdown-item ai-icon">
            ...
            <div class="deznav-scroll mm-active">
                <ul class="metismenu mm-show" id="menu">
                    <li class="<?= ($currentPage == 'index.php') ? 'mm-active' : '' ?>">
                        <a href="../view/index.php" class="ai-icon" aria-expanded="false">
                    ...
                    <li class="<?= ($currentPage == 'data_santri.php') ? 'mm-active' : '' ?>">
                        <a href="data_santri.php" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-381-television"></i>
                            <span class="nav-text">Data Mahasiswa</span>
                        </a>
                    </li>
                    <li class="<?= ($currentPage == 'data_operator.php') ? 'mm-active' : '' ?>">
                ...
                <div class="add-menu-sidebar">
                    ...
                    <a href="../action/logout.php" class="font-w500 mb-0">Logout</a>
                </div>
                <div class="copyright">
                    <p><strong>T2S System</strong> © 2023 All Rights Reserved</p>
                    <p>Made with <span class="heart"></span> by a.rf____</p>
                </div>
            </div>
        </div>
        <!--**********************************
